...
`activity_counts`, I’ll change the class of this variable to `integers`.
...
`week, day_id, day, activity, activity_counts, weekday_vs_weekend` as
variables, where `week, day_id, activity_counts` are integer variables
and `day, activity, weekday_vs_weekend` in character variables.*
