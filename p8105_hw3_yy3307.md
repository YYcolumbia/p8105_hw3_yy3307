...
<img src="p8105_hw3_yy3307_files/figure-gfm/unnamed-chunk-1-1.png" width="90%" />

``` r
snow_distribution
```

<img src="p8105_hw3_yy3307_files/figure-gfm/unnamed-chunk-1-2.png" width="90%" />

*From the `tmax_vs_tmin` density plot we can analyze the distribution of
maximum temperature and minimum temperature. Both curves looks slightly
bimodal with no skewness, where maximum temperature curve has a mean
value around 25 degrees C and minimum temperature curve has a mean value
around 0 degrees C. Also, minimum temperatures generally has a higher
density than maximum temperatures.* *The second plot indicates the
distribution of snowfall amount greater than 0 and less than 100
separately by year. From the plot we can tell the overall distribution
across all years didn’t change too much, all of them follow similar
shape distribution with slightly modifications in density. The vast
majority years of snowfall amounts is 10 mm and 25 mm.*
