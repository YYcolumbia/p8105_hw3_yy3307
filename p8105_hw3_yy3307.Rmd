...
_After manipulating the "accel" dataset, it contains `r nrow(accel_df)` rows and `r ncol(accel_df)` columns, which means that there are `r nrow(accel_df)` observations. We have `week, day_id, day, activity, activity_counts, weekday_vs_weekend` as variables, where `week, day_id, activity_counts` are integer variables and `day, activity, weekday_vs_weekend` in character variables._